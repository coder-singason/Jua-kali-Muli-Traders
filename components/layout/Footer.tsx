    ...
    <footer className={cn("border-t bg-card mt-auto transition-all duration-300", footerPadding)}>
      <div className="container mx-auto px-4 py-8 md:py-12">
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Quality electronics, home appliances, and juakali tools in Murang'a.
            </p>
          </div>
          <div>
        ...
        <div className="mt-8 border-t pt-6 text-center text-sm text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} JUA-KALI MULI TRADERS. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
