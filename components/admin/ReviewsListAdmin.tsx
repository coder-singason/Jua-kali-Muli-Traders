...
import { Star, Trash2, User, Package, Calendar, MessageSquare, Search, X } from "lucide-react";
...
interface ReviewsListAdminProps {
  reviews: Review[];
}

export function ReviewsListAdmin({ reviews: initialReviews }: ReviewsListAdminProps) {
  ...
  // Filter reviews client-side if search is provided
      ...
      {filteredReviews.length === 0 ? (
        <div className="py-12 text-center">
          ...
          <p className="text-muted-foreground">
            {search ? "No reviews found matching your search." : "No reviews yet."}
          </p>
        </div>
      ) : (
